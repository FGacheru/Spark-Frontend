...
@Component({
  selector: 'app-changelog-table-header',
  templateUrl: './changelog-table-header.component.html',
  styleUrls: ['./changelog-table-header.component.scss']
})
export class ChangeLogTableHeaderComponent implements OnInit {
